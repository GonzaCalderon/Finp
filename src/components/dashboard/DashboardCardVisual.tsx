...
export function DashboardCardVisual({
    ...
    return (
        <Link
            href={href}
            className={cn(
                'group relative block overflow-hidden rounded-[28px] border transition-all duration-300 ease-out hover:-translate-y-1 hover:border-foreground/[0.18]',
                isHero ? 'min-h-[256px]' : isCompact ? 'min-h-[218px]' : 'min-h-[232px]'
            )}
            style={{
        ...
        >
            ...
            <div className="relative flex h-full flex-col justify-between p-5 text-card-foreground">
                <div className="flex items-start justify-between gap-4">
                    <div className="space-y-2">
                        <div className="flex items-center gap-2">
                            <CreditCard
                                className="h-3.5 w-3.5 text-muted-foreground/70 transition-transform duration-300 ease-out group-hover:translate-x-0.5"
                            />
                    ...
                    <div className="flex flex-col items-end gap-3 text-right">
                        ...
                        <div className="flex justify-end">
                            <span
                                className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-foreground/10 bg-background/65 transition-all duration-300 ease-out group-hover:border-foreground/20 group-hover:bg-background/80 group-hover:shadow-[0_10px_24px_-18px_rgba(15,23,42,0.9)]"
                            >
                ...
                <div className="mt-6 grid gap-3 md:grid-cols-[1.15fr_0.85fr]">
                    <div className="rounded-[22px] border border-foreground/10 bg-background/60 p-4 transition-all duration-300 ease-out group-hover:-translate-y-0.5 group-hover:border-foreground/15">
                    ...
                    <div className="grid gap-3">
                        <div className="rounded-[22px] border border-foreground/10 bg-background/60 p-3 transition-all duration-300 ease-out group-hover:-translate-y-0.5 group-hover:border-foreground/15">
                ...
                <div className="mt-3 flex items-center justify-between gap-3 rounded-[22px] border border-foreground/10 bg-background/60 px-4 py-3 transition-all duration-300 ease-out group-hover:-translate-y-0.5 group-hover:border-foreground/15">
                    <div>
