        ...
        <StepSection>
            ...
            >
                <motion.div
                    ...
                    className="space-y-3 rounded-[1.85rem] border p-3.5 md:space-y-3.5 md:p-4"
                    style={{ borderColor: typeSurface.borderColor, background: typeSurface.background, boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.02)' }}
                >
                    {typeLabel && (
                        <p className="text-[0.82rem] font-semibold uppercase tracking-[0.1em]" style={{ color: typeSurface.color }}>
                            {typeLabel}
                        </p>
                    )}
