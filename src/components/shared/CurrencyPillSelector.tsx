            ...
            {options.map((currency) => {
                ...
                return (
                    <MotionButton
                        ...
                        className={cn(
                            'group relative isolate min-w-[4.75rem] flex-1 overflow-hidden rounded-full border bg-background/80 p-0 font-semibold shadow-none',
                    ...
                    >
                        ...
                        <span className="relative z-10 flex w-full items-center justify-center gap-1.5 px-2.5 tracking-[0.04em]">
                            <CurrencyFlagIcon
                                currency={currency}
                                className={compact ? 'h-4 w-6' : 'h-[18px] w-7'}
                            />
                            {currency}
                        </span>
                    </MotionButton>
