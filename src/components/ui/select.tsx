...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        // base
        "flex w-fit items-center justify-between gap-2 rounded-lg border border-input bg-transparent py-2 pr-2.5 pl-3 text-sm whitespace-nowrap",
        "outline-none select-none transition-all duration-150",
        // hover
        "hover:bg-accent/40 hover:border-ring/50",
        // open state
        "data-[state=open]:bg-accent/50 data-[state=open]:border-ring/60",
        // focus
        ...
        // sizes
        "data-[size=default]:h-9 data-[size=sm]:h-7 data-[size=sm]:rounded-md data-[size=sm]:px-2.5 data-[size=sm]:text-xs",
        // inner value
        "*:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-1.5",
        // svg base
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        // chevron rotation on open
        "[&>*:last-child]:transition-transform [&>*:last-child]:duration-200 data-[state=open]:[&>*:last-child]:rotate-180",
        className
      )}
      {...props}
    >
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "border border-foreground/[0.08] shadow-xl shadow-black/[0.1] dark:shadow-black/[0.4]",
          "duration-150",
