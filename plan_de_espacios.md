...
**Estado:** parcialmente implementada / queda Fase 5C.
...
* `SpaceSettlementDialog` con header de contexto, presets Total / 50% / Otro y preview saldo antes / pago / saldo restante.
* `SpaceBalanceSection` con títulos “Debés” / “Te deben”, descripción más corta y hint de simplificación para 3+ participantes.
* `MovementCard` rediseñado con layout denso: dot de color, título/metadatos, monto/status alineado y settlements como Pagador → Receptor.
* Filtro “Pagos” en lugar de “Liquidaciones”.
* `SpaceEntryDetailSheet` con “Recibió” para settlements y badge “En Finp personal” si hay `linkedTransactionId`.

Queda para Fase 5C:

* DatePicker y validaciones visibles de Nuevo movimiento.
* Resumen con deuda total general y CTA a Balance.
* Acción rápida de pago recomendado con confirmación de pago total.
* Compactación visual de pagos recomendados.
* Verificar que Balance usa siempre la versión actualizada del dialog.
